...
[![x-cmd/install — git-lfs Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/git-lfs.svg?lang=zh)](https://x-cmd.com/install/git-lfs)
...
合计: **70,980** 行代码（覆盖前 5 种语言、共 **453** 个文件）。
...
- **上游仓库**: <https://github.com/git-lfs/git-lfs>
...
- **Star**: 14,518 · **Fork**: 2,260 · **开放 issue**: 3,264 · **贡献者**: 233

## 累计统计

- **发布数**: 96 · **已合并 PR**: 2102 · **开放 PR**: 35 · **已关闭 issue**: 2819 · **开放 issue**: 445 · **提交数**: 9796

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 1 | 7 | 1 | 2 | 3 | 9 |
| last60d | 2026-07-27 | 1 | 16 | 8 | 4 | 7 | 32 |
| 90d | 2026-06-27 | 1 | 23 | 9 | 12 | 11 | 52 |
| last180d | 2026-03-29 | 1 | 51 | 13 | 22 | 16 | 157 |
| 360d | 2025-09-30 | 2 | 91 | 15 | 49 | 31 | 278 |
| last720d | 2024-10-05 | 5 | 153 | 22 | 113 | 88 | 791 |
...
git-lfs 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `git-lfs` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/git-lfs.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:14:06Z._
